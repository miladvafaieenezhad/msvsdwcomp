...
S {}
E {}
C {VSD/week1/function_pre-layout_Xschem/FN.sym} 50 60 0 0 {name=X1}
C {vdd.sym} 90 -230 0 0 {name=l1 lab=VDD}
...
C {lab_pin.sym} 30 -180 0 0 {name=l3 sig_type=std_logic lab=Va}
C {lab_pin.sym} 30 -140 0 0 {name=l4 sig_type=std_logic lab=Vb}
C {lab_pin.sym} 30 -90 0 0 {name=l5 sig_type=std_logic lab=Vc}
C {lab_pin.sym} 30 -50 0 0 {name=l6 sig_type=std_logic lab=Vd}
C {lab_pin.sym} 30 0 0 0 {name=l7 sig_type=std_logic lab=Ve}
C {lab_pin.sym} 30 40 0 0 {name=l8 sig_type=std_logic lab=Vf}
C {lab_pin.sym} 160 -170 2 0 {name=l9 sig_type=std_logic lab=Vo}
...
C {sky130/sky130_fd_pr/corner.sym} -130 -30 0 0 {name=TT_MODELS
only_toplevel=true
format="tcleval( @value )"
value=".lib /usr/local/share/pdk/sky130A/libs.tech/ngspice/sky130.lib.spice tt"
spice_ignore=false}
C {code_shown.sym} -130 150 0 0 {name=spice only_toplevel=false value=".tran 0.5n 1u
.measure tran delay
