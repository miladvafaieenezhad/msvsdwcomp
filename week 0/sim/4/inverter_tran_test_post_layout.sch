...
value=".include ~/.xschem/xschem_library/VSD/week0/inverter_post_layout.spice
.tran 1n 0.5u
.save all"}
...
spice_ignore=false}
C {VSD/week0/(5)Xschem_for_post_layout/inverter_post_layout.sym} 420 -320 0 0 {name=x1}
