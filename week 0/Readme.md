...
&#9733; there are inserted some useful webpages to install tools other than those introduced in [Task_week0](https://github.com/miladvafaieenezhad/msvsdwcomp/blob/main/week%200/Task_week0.md).
